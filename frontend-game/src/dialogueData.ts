    ...
    slides: [
      {
        ...
        buttonText: 'NEXT ▶',
        audioUrl: '/assets/audio/third-guide-almendras.mp4',
      },
      {
        speaker: 'Teacher Lovely',
        ...
        audioUrl: '/assets/audio/fourth-guide-almendras.mp4',
      },
    ],
  },
  2: {
    ...
    slides: [
      {
        ...
        buttonText: 'NEXT ▶',
        audioUrl: '/assets/audio/fifth-guide-almendras.mp4',
      },
      {
        speaker: 'Teacher Lovely',
        ...
        audioUrl: '/assets/audio/sixth-guide-almendras.wav',
      },
    ],
  },
  3: {
    ...
    slides: [
      {
        ...
        buttonText: 'NEXT ▶',
        audioUrl: '/assets/audio/7-guide-sarausas.wav',
      },
      {
        speaker: 'Teacher Annabelle',
        ...
        audioUrl: '/assets/audio/8-guide-sarausas.wav',
      },
    ],
  },
};
